                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="number" name="jumlah_tabung" x-model="jumlah" @focus="if(jumlah == 0) jumlah = ''" @blur="if(jumlah === '') jumlah = 0" required min="1" class="w-full px-4 py-2 border border-gray-200 rounded-xl text-sm font-bold text-indigo-600 focus:ring-2 focus:ring-emerald-500 transition">
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" name="jumlah_retur" value="{{ old('jumlah_retur', 0) }}" @focus="if($event.target.value == 0) $event.target.value = ''" @blur="if($event.target.value == '') $event.target.value = 0" min="0" class="w-full px-4 py-2 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-amber-500 transition" placeholder="0">
                            </div>
                            <div>

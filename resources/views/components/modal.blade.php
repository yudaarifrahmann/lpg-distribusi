...
<div
    x-data="{
        ...
        focusables() {
            ...
            let selector = 'a, button, input:not([type=\'hidden\']), select, textarea, [tabindex]:not([tabindex=\'-1\'])'
...
>
    ...
    <div
        x-show="show"
        class="relative z-10 mb-6 bg-white rounded-3xl overflow-hidden shadow-xl transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto"
        x-transition:enter="ease-out duration-300"

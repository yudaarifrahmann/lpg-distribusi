            ...
            <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg p-6 z-10" @click.away="showCreate = false">
                ...
                <form action="{{ route('pangkalan.store') }}" method="POST" class="space-y-4">
                    ...
                    <div class="flex justify-end space-x-3 pt-4 border-t">
                        ...
                        <button type="submit" class="px-6 py-2.5 text-sm font-semibold text-white bg-blue-600 rounded-lg shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 transition">Simpan</button>
                    </div>
                </form>
            </div>
        </div>

    ...
    <div class="flex h-screen" x-data="{ sidebarOpen: true, masterDataOpen: {{ request()->is('master-data/*') ? 'true' : 'false' }}, reportOpen: {{ request()->is('laporan/*') ? 'true' : 'false' }} }">
        ...
        <aside class="fixed lg:static inset-y-0 left-0 z-30 w-64 bg-gray-900 text-gray-100 shadow-2xl transform transition-transform duration-300 ease-in-out overflow-y-auto flex flex-col"
            ...
            <nav class="flex-1 mt-4 px-3 space-y-1">
                ...
                @canany(['view pengeluaran', 'create pengeluaran'])
                <a href="{{ route('expense.index') }}" class="sidebar-link {{ request()->routeIs('expense.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM7 9a1 1 0 000 2h6a1 1 0 100-2H7z" clip-rule="evenodd"/></svg>
                    Pengeluaran
                </a>
                @endcanany
                ...
                <a href="#" class="sidebar-link"><svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20"><path d="M9 6a3 3 0 11-6 0 3 3 0 016 0zM17 6a3 3 0 11-6 0 3 3 0 016 0zM12.93 17c.046-.327.07-.66.07-1a6.97 6.97 0 00-1.5-4.33A5 5 0 0119 16v1h-6.07zM6 11a5 5 0 015 5v1H1v-1a5 5 0 015-5z"/></svg>User Management</a>

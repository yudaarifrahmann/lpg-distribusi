        ...
        <aside class="fixed lg:static inset-y-0 left-0 z-30 w-64 bg-gray-900 text-gray-100 shadow-2xl transform transition-transform duration-300 ease-in-out overflow-y-auto flex flex-col no-scrollbar"
            ...
            <nav class="flex-1 mt-4 px-3 space-y-1">
                ...
                <a href="{{ route('expense.index') }}" class="sidebar-link {{ request()->routeIs('expense.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z" /><path fill-rule="evenodd" d="M4 5a2 2 0 012-2 3 3 0 003 3h2a3 3 0 003-3 2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm3 4a1 1 0 000 2h6a1 1 0 100-2H7zm0 4a1 1 0 100 2h6a1 1 0 100-2H7z" clip-rule="evenodd" /></svg>
                    History Pengeluaran
                </a>
                @endcan
                @endcanany
